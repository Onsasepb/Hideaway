package com.example.hideaway.ui.theme.screens.thought
...
@Composable
fun Thought(navController: NavController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
fun NoteScreen() {
    ...
    Column(
        ...
        TextField(
            ...
            label = { Text("WHAT DO I WANT TO DO TODAY;",
                fontFamily = FontFamily.Cursive,
...
fun GratitudeScreenPreview(){
    WazitoECommerceTheme {
        Thought(navController = rememberNavController())
        NoteScreen()
